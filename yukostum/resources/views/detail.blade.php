        ...
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark">
                            ...
                            <div class="carousel-inner" style="height: 500px;">
                                @foreach($costume->images as $index => $img)
                                    <div class="carousel-item h-100 {{ $index == 0 ? 'active' : '' }}">
                                        <img src="{{ asset('images/kostum/' . $img) }}" class="d-block w-100 h-100 object-fit-cover" alt="Foto {{ $costume->name }}">
                                    </div>
                                @endforeach
                            </div>
                    ...
                    @else
                        <div class="h-100 d-flex justify-content-center align-items-center bg-light text-muted" style="min-height: 400px;">
                ...
                <div class="col-md-6 d-flex flex-column">
                    <div class="card-body p-5">
                        ...
                        <div class="mt-auto pt-3">
                            @if($costume->stock > 0)
                                <a href="/sewa/{{ $costume->id }}" class="btn btn-primary btn-lg w-100 fw-bold py-3 shadow-sm">
                                    🛒 SEWA SEKARANG
                                </a>
                            @else
                                <button class="btn btn-danger btn-lg w-100 fw-bold py-3" disabled>STOK HABIS</button>
                            @endif
                            <a href="/katalog" class="btn btn-light w-100 mt-2 text-muted fw-bold">Kembali ke Katalog</a>
                        </div>
