                    ...
                    <form action="/admin/kostum" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="color" class="form-control" placeholder="Contoh: Merah, Putih"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="price" class="form-control" placeholder="Contoh: 50000"
                                    required>
                            </div>
                ...
                <div class="card-body p-0 table-responsive">
                    <table class="table table-striped table-hover mb-0 align-middle">
                        ...
                        <tbody>
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            <form action="/admin/kostum/{{ $kostum->id }}" method="POST">
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm fw-bold"
                                                    onclick="return confirm('Yakin ingin menghapus kostum {{ $kostum->name }} ini?')">Hapus</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">Belum ada kostum yang
                                        ditambahkan.</td>
                                </tr>
                            @endforelse
                        </tbody>
