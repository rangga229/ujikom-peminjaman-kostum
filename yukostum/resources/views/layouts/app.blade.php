...
<head>
    ...
    <style>
        body {
            ...
            /* Warna latar belakang abu-abu sangat muda agar elegan */
        }
    </style>
</head>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav ms-auto">
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-warning text-dark fw-bold ms-2 px-3 py-1 mt-1"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                    <li>
                                        <form action="/logout" method="POST">
                                            @csrf
                                            <button type="submit" class="dropdown-item text-danger fw-bold">🚪 Keluar
                                                (Logout)</button>
                                        </form>
                                    </li>
                                </ul>
