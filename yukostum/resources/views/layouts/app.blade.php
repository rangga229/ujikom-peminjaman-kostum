    ...
    <nav class="navbar navbar-expand-lg navbar-dark mb-4 shadow-sm" style="background-color: #2c5e7b;">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="#">
                <img src="{{ asset('images/logo_circle_yukostum.png') }}" alt="Logo Katak" width="45" height="45" class="me-2 rounded-circle border border-2 border-white">
                🎭 YUKOSTUM
            </a>
