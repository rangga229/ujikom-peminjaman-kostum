                ...
                <table class="table table-hover mb-0 align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start">
                                <span class="fw-bold text-primary">{{ $sewa->costume->name ?? 'Baju Dihapus' }}</span>
                            </td>
                            ...
                            <td>
                                ...
                                @elseif($sewa->status == 'disetujui')
                                    <span class="badge bg-primary px-3 py-2">Disetujui / Sedang Disewa</span>
                                @elseif($sewa->status == 'selesai')
                                    <span class="badge bg-success px-3 py-2">Selesai Dikembalikan</span>
                                @else
